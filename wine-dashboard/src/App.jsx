...
import MetricsCard from './components/Metrics/MetricsCard'; // ✅ Import the component correctly
...
function App() {
  const [wineData] = useState([
    {
      ...
      RETAIL_SALES: 1000,
      WAREHOUSE_SALES: 500,
      RETAIL_TRANSFERS: 100,
      review_price: 25,
      review_variety: 'Cabernet',
      review_country: 'USA',
      SUPPLIER: 'Test Supplier',
      review_region_1: 'Napa',
      review_winery: 'Test Winery'
    }
  ]);
  ...
  const metrics = {
    ...
    unique_skus: (filteredData || []).length,
